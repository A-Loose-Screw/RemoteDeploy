...
public class DeployExtension {
  ...
  private ArtifactExtension _componentExtension;
  ...
  public DeployExtension(Project project) {
    ...
    this._componentExtension = ((ExtensionAware)this).getExtensions().create("artifacts", ArtifactExtension.class, project);
  }
